...
<div class="wrapper">
  ...
  <footer class="main-footer text-sm">
    <strong>Copyright &copy; 2014-<?php echo date('Y'); ?> <a target='_BLANK' href="http://www.mycoding.net/"><?php echo $iden['nama_website']; ?></a>.</strong>
    All rights reserved.
...
<script src="<?php echo base_url(); ?>asset/admin_mu/plugins/tempusdominus/js/moment.min.js"></script>
<script src="<?php echo base_url(); ?>asset/admin_mu/plugins/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
